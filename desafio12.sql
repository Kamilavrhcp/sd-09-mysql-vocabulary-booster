...
WHERE employee1.JOB_ID = employee2.JOB_ID AND employee1.EMPLOYEE_ID <> employee2.EMPLOYEE_ID
ORDER BY CONCAT(employee1.FIRST_NAME, ' ', employee1.LAST_NAME), CONCAT(employee2.FIRST_NAME, ' ', employee2.LAST_NAME);
