SELECT CONCAT(hEmp.first_name, ' ', hEmp.last_name) AS `Nome completo funcionário 1`,
...
FROM hr.employees AS hEmp,
  hr.employees AS hEmp2
WHERE hEmp.JOB_ID = hEmp2.JOB_ID AND hEmp.EMPLOYEE_ID <> hEmp2.EMPLOYEE_ID
