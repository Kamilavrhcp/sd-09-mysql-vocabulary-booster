...
BEGIN
SELECT ROUND(AVG(e.SALARY), 2) AS 'Média Salarial' FROM employees AS e INNER JOIN jobs AS j ON e.JOB_ID = j.JOB_ID GROUP BY JOB_TITLE HAVING j.JOB_TITLE = cargo;
END $$
